    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Achat effectuer</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer clearfix">
                <pagination align="right" :data="surveys"
                            @pagination-change-page="fetchSurveys"  :limit="8"></pagination>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchSurveys(page = 1){
                var self = this;
                Vue.axios.get("/purchasesurvey?page=" + page+"&filter="+JSON.stringify(this.filter)).then(function (response) {
