...
<template>
    ...
    <div class="example-modal-content d-flex flex-column col-md-12">
        <div class="card-header d-flex justify-content-center"
            ...
            <h2 v-if="edit">Modifier un point de vente </h2>
            <h2 v-else>Ajouter un point de vente</h2>
        </div>
        ...
        methods: {
            ...
            user(){
                ...
                if (!this.$props.edit) {
                    ...
                    Vue.axios.post("/salepoint", this.formData).then(function (response) {
                    ...
                    Vue.axios.patch("/salepoint/" + this.$props.id, this.formData).then(function (response) {
                        // self.brands = response.data;
                        console.log(response);
                        self.closeByEvent();
                        self.error = false;
            ...
            getSupplier(id){
                var self = this;
                Vue.axios.get("/salepoint/" + id).then(function (response) {
