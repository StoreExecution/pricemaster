...
<div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="/img/dashlogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Price Master</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="#">Store Execution</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
